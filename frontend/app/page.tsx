...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#0a0a0b]">
      ...
      {/* Hero — Liquid Ether background (reactbits.dev/backgrounds/liquid-ether style) */}
      <section className="relative flex min-h-[85dvh] flex-col items-center justify-center px-6 pt-24 text-center">
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          ...
          <div className="absolute inset-0 min-h-[600px]">
            <LiquidEther color="#22d3ee" opacity={0.4} speed={0.5} mouseInteractive={true} />
          </div>
        </div>
      ...
      <section id="features" className="border-t border-white/[0.06] py-16 px-6 md:py-20">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="relative mt-10 grid w-full grid-cols-1 auto-rows-auto gap-2 sm:grid-cols-6 sm:grid-rows-6 sm:h-[80vh] sm:min-h-[500px]">
            {[
              { name: "Patent Vault", desc: "Tokenize scientific patents into IP-NFTs for secure, on-chain DeFi utility.", href: "/app/vault", bento: "sm:col-span-6 sm:col-start-1 sm:row-span-2 sm:row-start-1", image: "/images/patent-vault.png" },
              { name: "Patent Backed-Lending", desc: "Collateralize IP-NFTs to access instant funding for development.", href: "/app/lending", bento: "sm:col-span-2 sm:col-start-1 sm:row-span-4 sm:row-start-3", image: "/images/lending.jpg" },
              { name: "Yield and Staking", desc: "Earn ecosystem yield from patent revenues and marketplace activity.", href: "/app/staking", bento: "sm:col-span-4 sm:col-start-3 sm:row-span-2 sm:row-start-3", image: "/images/staking.jpg" },
              { name: "Patent-Funding", desc: "Get expert-vetted funding to commercialize your intellectual property.", href: "/app/funding", bento: "sm:col-span-2 sm:col-start-3 sm:row-span-2 sm:row-start-5", image: "/images/funding.jpg" },
              { name: "Marketplace", desc: "The RWA exchange for trading, licensing, and fractionalizing patent assets.", href: "/app/marketplace", bento: "sm:col-span-2 sm:col-start-5 sm:row-span-2 sm:row-start-5", image: "/images/marketplace.jpg" },
            ].map((item) => (
              <Link
                key={item.name}
                href={item.href}
              ...
              >
                <Image src={item.image} alt="" fill className="object-cover opacity-40 group-hover:opacity-50 transition-opacity" />
                <span className="absolute inset-0 z-0 bg-gradient-to-t from-zinc-900/95 via-zinc-900/70 to-transparent" aria-hidden />
                <span
                ...
                <h3 className="relative z-10 font-display text-xl font-bold text-white sm:text-2xl group-hover:text-cyan-400/90 transition-colors">{item.name}</h3>
                <p className="relative z-10 mt-3 text-base leading-relaxed text-zinc-500">{item.desc}</p>
              </Link>
            ))}
          </div>
        </div>
      ...
      <section id="how-it-works" className="border-t border-white/[0.06] bg-zinc-950/50 py-16 px-6 md:py-20">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="relative mt-10 aspect-[2/1] max-h-[320px] w-full overflow-hidden rounded-xl border border-zinc-800/80 md:max-h-[280px]">
            <Image src="/images/how-it-works.jpg" alt="How NanoFi works" fill className="object-cover opacity-80" />
          </div>
      ...
      <section className="border-t border-white/[0.06] py-16 px-6 md:py-20">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="relative mx-auto mt-8 max-w-2xl overflow-hidden rounded-xl border border-zinc-800/80">
            <Image src="/images/testimonials.jpg" alt="" width={672} height={280} className="h-44 w-full object-cover opacity-90 md:h-52" />
          </div>
      ...
      <section className="border-t border-white/[0.06] bg-zinc-950/50 py-14 px-6">
        <div className="mx-auto max-w-4xl">
          <div className="relative mb-8 aspect-[2/1] max-h-[240px] w-full overflow-hidden rounded-xl border border-zinc-800/80">
            <Image src="/images/chainlink.jpg" alt="Powered by Chainlink" fill className="object-cover opacity-80" />
          </div>
