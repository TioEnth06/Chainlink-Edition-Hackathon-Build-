      ...
      <section className="relative flex min-h-[85dvh] flex-col items-center justify-center px-6 pt-24 text-center">
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <div className="absolute inset-0 min-h-[600px]">
            <Plasma color="#22d3ee" speed={0.5} direction="forward" scale={1.2} opacity={0.22} mouseInteractive={true} />
          </div>
        </div>
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-cyan-500/[0.04] via-transparent to-[#0a0a0b]" />
      ...
      <section id="features" className="border-t border-white/[0.06] py-16 px-6 md:py-20">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="relative mt-10 grid w-full grid-cols-1 auto-rows-auto gap-2 sm:grid-cols-6 sm:grid-rows-6 sm:h-[80vh] sm:min-h-[500px]">
            {[
              { name: "Patent Vault", desc: "Tokenize scientific patents into IP-NFTs for secure, on-chain DeFi utility.", href: "/app/vault", bento: "sm:col-span-6 sm:col-start-1 sm:row-span-2 sm:row-start-1" },
              { name: "Patent Backed-Lending", desc: "Collateralize IP-NFTs to access instant funding for development.", href: "/app/lending", bento: "sm:col-span-2 sm:col-start-1 sm:row-span-4 sm:row-start-3" },
              { name: "Yield and Staking", desc: "Earn ecosystem yield from patent revenues and marketplace activity.", href: "/app/staking", bento: "sm:col-span-4 sm:col-start-3 sm:row-span-2 sm:row-start-3" },
              { name: "Patent-Funding", desc: "Get expert-vetted funding to commercialize your intellectual property.", href: "/app/funding", bento: "sm:col-span-2 sm:col-start-3 sm:row-span-2 sm:row-start-5" },
              { name: "Marketplace", desc: "The RWA exchange for trading, licensing, and fractionalizing patent assets.", href: "/app/marketplace", bento: "sm:col-span-2 sm:col-start-5 sm:row-span-2 sm:row-start-5" },
            ].map((item) => (
              <Link
                key={item.name}
                href={item.href}
              ...
              >
                ...
                <h3 className="font-display text-xl font-bold text-white sm:text-2xl group-hover:text-cyan-400/90 transition-colors">{item.name}</h3>
